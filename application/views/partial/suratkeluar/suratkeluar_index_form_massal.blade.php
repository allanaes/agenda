@section('display_form')
	<div class="row">
    <ul class="breadcrumb">
	    <li class="active"><i class="icon-tag"></i> {{ HTML::link_to_route('suratkeluar', 'Input Surat Keluar')}}<span class="divider">//</span></li>
	    <li>
	    	<i class="icon-tags"></i> Input Surat Keluar Massal
	    </li>
    </ul>
  </div>
	...
	<div class="row">
		<div class="bordered">
			{{ Form::open('suratkeluar/createmassal', 'POST', array('class'=>'form')) }}
				{{ Form::token() }}
				<table class="maxwidth">
					...
					<tr>
						...
						<td>
							{{ Form::textarea('tujuan', e($placeholder_tujuan), array('class'=>'span6')) }}<br>
							<span>** Masukan daftar tujuan dengan pemisah tanda titik-koma ";".</span>
						</td>
					</tr>
